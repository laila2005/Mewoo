...
const MOCK_PRODUCTS = [
    ...
    { id: 'p2', type: 'product', category: 'accessories', title: 'Heavy Duty Rope Leash with Reflective Thread', description: 'Durable 6ft climbing rope leash with padded handle for maximum comfort.', base_price: 850, image: 'https://images.unsplash.com/photo-1606814893907-c2e425640277?w=400&q=80', rating: 4.9, reviews: 89, badge: 'New' },
    ...
    { id: 'p8', type: 'product', category: 'toys', title: 'Tough Chew Indestructible Bone', description: 'Designed for aggressive chewers. Made from durable non-toxic rubber.', base_price: 800, image: 'https://images.unsplash.com/photo-1584025175659-46700c293ed9?w=400&q=80', rating: 4.4, reviews: 840 },
    { id: 'sub1', type: 'product', category: 'subscriptions', title: 'PulseBox: The Puppy Starter Kit', description: 'Monthly delivery of teething toys, training treats, and puppy wellness guides.', base_price: 1500, image: 'https://images.unsplash.com/photo-1601612450849-2d2cce7c6888?w=400&q=80', rating: 5.0, reviews: 1205, badge: 'Popular Plan' },
