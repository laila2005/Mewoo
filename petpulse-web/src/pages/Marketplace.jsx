...
const Marketplace = () => {
    ...
    const handleAddFromDetails = () => {
        ...
        setCart(prev => {
            ...
            return [...prev, { ...selectedProduct, quantity: detailQuantity }];
        });
    ...
    const cartTotal = cart.reduce((sum, c) => sum + (c.base_price * c.quantity), 0);
    ...
    const marketplaceSchema = {
        ...
        "url": "https://petpluse-web.vercel.app/marketplace",
