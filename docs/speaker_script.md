...
**Total Speakers:** 9 (3 Web Team, 3 AI Team, 3 Security Team)
...
Pet-care services today are highly fragmented. As pet owners, we often struggle to find reliable help quickly, especially during emergencies. Existing platforms lack intelligent triage and suffer from weak data protection. PetPulse was engineered from the ground up by our Web, AI, and Security teams to solve these exact problems with a centralized, secure, and intelligent ecosystem."

### Speaker 2: Project Objectives
**(Slide 2)**
"To tackle these issues, our primary objective was to build a single, unified hub. But a great idea requires flawless execution. Our goal is frictionless access to vet services, driven by AI and secured by enterprise-grade encryption. We are building a practical system ready for real-world application, ensuring both scalability and reliability from day one."

### Speaker 3: Core Web Features
...
Users can book verified vets instantly, post lost-and-found alerts with precise GPS locations, and safely arrange adoptions. We've also integrated a real-time WebSocket chat to build a highly active community, allowing direct communication between pet owners, trainers, and service providers. The frontend is fully responsive, ensuring a premium experience that connects flawlessly with our backend services."

---

## 🔵 AI TEAM

### Speaker 4: AI Integration & Symptom Analysis
**(Slide 5)**
...
### Speaker 6: Intelligent Matching System
**(Slide 7)**
...
### Speaker 7: The Critical Role of Security
**(Slide 8)**
...
### Speaker 8: Active Threat Protection & Monitoring
**(Slide 9 - Security Monitor)**
...
### Speaker 9: Future Roadmap & Progress Checklist
**(Slide 9 & 10)**
"To manage a project of this scale with 9 engineers, we integrated Jira into our workflow. Looking ahead, our roadmap includes expanding to native Android and iOS applications, training our AI on larger datasets, and introducing IoT integration—like smart collars—for proactive health monitoring.
