...
import { createPet, getPets, getPetById, updatePet, deletePet, getAdoptablePets, getMatingPets, uploadMedicalRecord, addVaccination, getVaccinations } from '../controllers/petController.js';
