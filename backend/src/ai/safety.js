...
const EMERGENCY_PATTERNS = [
  ...
  // Arabic
  /نوبة|تشنج|اختلاج/,
  /لا [يت]تنفس|صعوبة في التنفس|[يت]ختنق|اختناق/,
  /فاقد[ةه]? الوعي|إغماء|لا [يت]ستجيب|أغمي علي(ه|ها)/,
  /نزيف (شديد|حاد)|[يت]نزف بغزارة/,
  ...
  /تسمم|سم فئران|[أا]كل[ته]? شوكولاتة|ابتلع[ته]? (سم|دواء|شيء)|بلع[ته]? (سم|دواء)|[أا]كل[ته]? سم/,
  /انتفاخ|نفاخ المعدة|التواء المعدة/,
  /(دهس|صدم)(ته|تها|ه|ها)?\s*سيارة/,
...
const URGENT_PATTERNS = [
  ...
  /لا [يت]أكل|رفض[ته]? الأكل|فقدان الشهية|لا [يت]شرب/,
  /خمول|ضعف شديد|لا [يت]تحرك/,
  /[يت]عرج|لا [يت]ستطيع المشي|لا [يت]قف/,
  /تورم|خراج|ورم/,
  /التهاب (العين|الأذن)|إفرازات/,
  /صعوبة في التبول|لا [يت]ستطيع التبول/,
  /حمى|حرارة/,
];
