...
// case-insensitively, and we also reject anything containing "petpulse"/"mewoo".
...
export function validatePasswordStrength(password, { email = '', name = '' } = {}) {
  ...
  if (/petpulse|mewoo/.test(lower)) return { ok: false, error: 'Password must not contain the site name.' };
